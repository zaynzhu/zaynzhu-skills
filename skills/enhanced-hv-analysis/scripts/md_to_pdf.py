...
def main():
    ...
    parser.add_argument("--author", default="研究者", help="作者名")
    ...
    for line in md_text.split("\n"):
        ...
        if "研究时间" in stripped or "研究截止时间" in stripped or "所属领域" in stripped or "研究对象类型" in stripped:
            meta_line = stripped
            break
