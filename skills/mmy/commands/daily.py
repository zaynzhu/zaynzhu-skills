...
def main() -> int:
    parser = argparse.ArgumentParser(description="生成当日汇总日报")
    parser.add_argument("--sources", help="覆盖配置的平台（逗号分隔）")
    parser.add_argument("--output", help="输出文件名（默认 mmy-daily-YYYYMMDD.md）")
    ...
    filename = args.output or f"mmy-daily-{today}.md"
