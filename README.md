...
[![Skills](https://img.shields.io/badge/Skills-11-6366f1?style=flat&logo=sparkles&logoColor=white)](./skills/)
...
| 🐾 | [**pet**](./skills/pet/) | CLI 编程伴侣宠物。提供有持久属性的猫/狗宠物，能对工作状态做出实时反应，支持养成升级、状态栏集成、Hook 自动互动，兼容 Claude Code / Codex CLI / OpenCode 三平台 | `stable` |
